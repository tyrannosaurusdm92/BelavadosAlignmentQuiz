...
The in-program **Data & Sources** workspace displays the same distinctions from `json/source-provenance.json`.
...
Files: `js/character-sheet-library.js`, `json/systems/**`, `docs/character-sheets-v6/**`.
...
- `js/encounter-lab.js` — campaign-scoped weighted tables, encounter prompts, history, JSON import/export, and Creator Area publication records.
- `js/campaign-helpers.js` — campaign relationship graph, local name generator, fictional tavern dice helpers, JSON import/export, and publication records.
- `js/v6-integrations.js` — workspace routing, campaign permission gates, creator inventory integration, and public-snapshot filtering.
- `css/v6-helpers.css` — responsive presentation for the v6 helper workspaces.
