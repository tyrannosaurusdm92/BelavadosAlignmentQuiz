...
window.EMPEROR_ONYX_RULEBOT_DATA = {
  ...
  persona: {
    identity: "Lord Onyx Blepman, Emperor Of The Voidattude is a black cat in a green plaid bowtie collar and the heart of this helper bot.",
  ...
  quickPrompts: [
    { key: "dice", label: "Dice", prompt: "roll d20+5 with advantage" },
    { key: "multiroll", label: "Multi-Roll", prompt: "roll 3d6+2 and 1d8 and 4d4" },
  ...
  commandHelp: [
    ...
    ["roll d20+5 with advantage", "Roll one or many dice naturally in chat. Supports advantage/disadvantage, targets, modifiers, and quickrolls."],
    ["mod wis=4", "Create or change a named dice modifier."],
    ["qroll perception=d20+wis+level", "Create a quickroll."],
    ["find tavern", "Search parsed lore and loaded JSON tables."],
    ["json", "Show the current loaded Onyx helper JSON summary."],
